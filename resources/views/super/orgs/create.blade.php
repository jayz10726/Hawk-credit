...
<div class="max-w-2xl mx-auto">
    <h1 class="text-xl font-bold text-gray-800 mb-6">Create Organization</h1>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="address" rows="2"
                              class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none resize-none">{{ old('address') }}</textarea>
                </div>
        <div class="grid grid-cols-2 gap-4">
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <a href="{{ route('super.orgs.index') }}"
                       class="px-6 py-2.5 border border-gray-200 text-gray-600 text-sm rounded-lg hover:bg-gray-50">
                        Cancel
                    </a>
                </div>
            </div>
