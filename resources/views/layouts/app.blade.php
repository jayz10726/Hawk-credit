...
<aside class="fixed inset-y-0 left-0 z-50 w-72 flex flex-col bg-slate-950 border-r border-slate-800/60
    ...
    <nav class="flex-1 px-4 py-5 space-y-1 overflow-y-auto">
        @role('super_admin')
        {{-- SYSTEM --}}
        <p class='px-3 mb-2 mt-1 text-xs font-mono font-semibold text-slate-600 uppercase tracking-widest'>System</p>
        ...
        {{-- CREDIT MANAGEMENT --}}
        <p class='px-3 mb-2 mt-4 text-xs font-mono font-semibold text-slate-600 uppercase tracking-widest'>Credit Management</p>
        <x-nav-item :href="route('super.loans.index')" :active="request()->routeIs('super.loans.*')">
            <x-slot:icon><svg class='w-4 h-4' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'/></svg></x-slot:icon>
            All Loans
        </x-nav-item>
        <x-nav-item :href="route('super.requests.index')" :active="request()->routeIs('super.requests.*')">
        ...
        <x-nav-item :href="route('super.repayments.index')" :active="request()->routeIs('super.repayments.*')">
            <x-slot:icon><svg class='w-4 h-4' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M17 9V7a2 2 
         0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z'/></svg></x-slot:icon>
            Repayments
        </x-nav-item>
        {{-- FINANCIAL --}}
        <p class='px-3 mb-2 mt-4 text-xs font-mono font-semibold text-slate-600 uppercase tracking-widest'>Financial</p>
        <x-nav-item :href="route('super.credit-pools')" :active="request()->routeIs('super.credit-pools')">
            <x-slot:icon><svg class='w-4 h-4' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4'/></svg></x-slot:icon>
            Credit Pools
        </x-nav-item>
        <x-nav-item :href="route('super.penalties.index')" :active="request()->routeIs('super.penalties.*')">
            <x-slot:icon><svg class='w-4 h-4' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z'/></svg></x-slot:icon>
            Penalty Manager
        </x-nav-item>
        {{-- SYSTEM SETTINGS --}}
        <p class='px-3 mb-2 mt-4 text-xs font-mono font-semibold text-slate-600 uppercase tracking-widest'>Settings</p>
        <x-nav-item :href="route('super.audit-logs')" :active="request()->routeIs('super.audit-logs')">
            <x-slot:icon><svg class='w-4 h-4' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'/></svg></x-slot:icon>
            Audit Logs
        </x-nav-item>
        <x-nav-item :href="route('super.system-health')" :active="request()->routeIs('super.system-health')">
            <x-slot:icon><svg class='w-4 h-4' fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18'/></svg></x-slot:icon>
            System Health
        </x-nav-item>
        {{-- REPORTS --}}
        <p class='px-3 mb-2 mt-4 text-xs font-mono font-semibold text-slate-600 uppercase tracking-widest'>Reports</p>
        ...
        <x-nav-item :href="route('super.reports.loans')" :active="request()->routeIs('super.reports.*')">
